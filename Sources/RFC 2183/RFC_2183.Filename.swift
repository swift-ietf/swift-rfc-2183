...
extension RFC_2183.Filename: Swift.RawRepresentable, ASCII.Serializable, Binary.Serializable {
    ...
    /// re-emitting the validated filename `rawValue` directly into the `Byte`
    /// domain (RFC 2183 filenames are ASCII) — an independent body, not a
...
extension RFC_2183.Filename: CustomStringConvertible {
    /// The validated filename — the same text the `ASCII.Serializable` /
